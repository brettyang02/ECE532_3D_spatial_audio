...
HD_PWD='C:/Users/eliza/Documents/1_Local/ECE532_local/gyro_test/gyro_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_gyro_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_gyro_wrapper.tcl -notrace
