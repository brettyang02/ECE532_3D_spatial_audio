...
HD_PWD='C:/Users/eliza/Documents/1_Local/ECE532_local/gyro_test/gyro_test.runs/design_gyro_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_gyro_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_gyro_microblaze_0_0.tcl
