...
int main() {
    ...
    while (1) {
        ...
        if (isDataReady(&myGyro)) {
			...
			// 0.07 * 0.5 * 0.75 = 0.02625 is the experimental correct value when constantly accessing UART
			float magic_multiplier = 0.07 / 16;
