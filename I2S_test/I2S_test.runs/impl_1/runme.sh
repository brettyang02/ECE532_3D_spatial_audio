...
HD_PWD='C:/Users/andyl/Desktop/UofT/Semesters/4B/ECE_532/Milestones/Milestone_2/I2S_test/I2S_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_i2s_loopback.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_i2s_loopback.tcl -notrace
