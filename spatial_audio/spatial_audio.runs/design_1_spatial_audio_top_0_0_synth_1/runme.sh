...
HD_PWD='D:/Vivado_Projects/ECE532_SpatialAudio/ECE532_SpatialAudio.runs/design_1_spatial_audio_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_spatial_audio_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_spatial_audio_top_0_0.tcl
