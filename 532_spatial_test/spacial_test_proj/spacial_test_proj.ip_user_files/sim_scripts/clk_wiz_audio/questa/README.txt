...
#
# Generated by export_simulation on Thu Jan 29 15:10:37 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_audio.sh' script.

./clk_wiz_audio.sh -reset_run
...
./clk_wiz_audio.sh -noclean_files

For more information on the script, please type './clk_wiz_audio.sh -help'.
