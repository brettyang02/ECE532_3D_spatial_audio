...
HD_PWD='D:/ECE532/532_spatial_test/spacial_test_proj/spacial_test_proj.runs/rom_hrtf_left_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_hrtf_left.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_hrtf_left.tcl
