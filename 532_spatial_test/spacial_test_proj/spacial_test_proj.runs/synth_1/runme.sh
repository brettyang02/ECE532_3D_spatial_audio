...
HD_PWD='D:/ECE532/532_spatial_test/spacial_test_proj/spacial_test_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spatial_audio_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spatial_audio_top.tcl
