...
HD_PWD='D:/ECE532/532_spatial_test/spacial_test_proj/spacial_test_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spatial_audio_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spatial_audio_top.tcl -notrace
